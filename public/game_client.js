export class CardGame {
   ...
   set_acey_ducey_mode(on) {
      this._send('set_acey_ducey_mode', {
         on
      });
   }
   ...
   change_active_player(player) {
      this._send('change_active_player', {
         player
      });
   }
   ante(amt) {
